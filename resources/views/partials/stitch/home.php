...
<img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="A focused high school student in a blue Kenyan school uniform studying diligently in a well-lit classroom filled with books and maps. The photograph conveys a sense of ambition and the transformative power of education, with natural sunlight streaming through a window. The style is crisp, with warm tones and professional composition." src="https://lh3.googleusercontent.com/aida-public/AB6AXuARclKRIU-hevJGpAwTkB679NRyN4VXT84rG9Z08LQ_YudWy20eo80qoymrarJQy0Nx-toHn5wWd-nDi6ah0_SqXAxJLS5SRWSUhEqvsuRuMs5CX5W1SRuu6GoIkPbu1b2VaUWLV7AsDWRvSrYiDztZLfzSl9tChRxXkUyvIy3MI6JrCZk88HrW2l4tT18EqV5ciiqJJeaI9hYi8AROBN9LeCVsvJd4R4yvkpGAXZvUC0e9aklxUH7KgQ"/>
...
<div class="relative group akfo-card-tall min-h-[280px] md:h-[500px] rounded-3xl overflow-hidden shadow-xl">
<img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="A group of Kenyan women entrepreneurs working together in a textile workshop, sewing colorful traditional fabrics. They are smiling, sharing ideas, and demonstrating professional craftsmanship. The setting is bright and industrious, symbolizing economic independence and collaborative empowerment. The lighting is soft and flattering, highlighting textures and colors." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQXLakbLaCqJlgeu1vY-BbchFzKMi03k42MNpW2hHnRa02RTIb9i3F28Lrw0M-B7KOXTRmucG8ccfNA6oWtGm2A3hTDRTYgshoOZf5q7tl3ALD_ivA1DpITw-SFhyr2It8WGc-LW-1cKxe-dpygg57JgW-sEgG7fokomgF_KuuBX3pFEroAXjJRMP3va4AmlX63sUB_CLF-ScvuRDaPF24djOt-vSr46Je7hf8KYB4u63ghbWtu3qfWA"/>
<div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
<div class="absolute top-6 right-6 px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white font-label-bold text-label-bold">
                        Entrepreneurship
                    </div>
